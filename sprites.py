...
class Player(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.game = game
        self.dir = 'up'
        self.image = game.player_images[self.dir]
    ...
    def gey_keys(self):
        ...
        if keys[pygame.K_LEFT]:
            ...
            self.weapon = Weapon(self.game, self.x, self.y, self.dir)
        self.image = self.game.player_images[self.dir]
...
class Weapon(pygame.sprite.Sprite):
    def __init__(self, game, x, y, dir):
        ...
        pygame.sprite.Sprite.__init__(self, self.groups)
        self.game = game
        self.image = game.weapon_images[dir]
        self.rect = self.image.get_rect()
        player = game.player
        if dir == 'left':
        ...
        if dir == 'right':
            self.rect.x = x+player.rect.width/2+self.rect.width/4
...
class Virus(pygame.sprite.Sprite):
    ...
    def draw_health(self):
        if self.type == 'shoot':
            ...
            width = self.rect.width * self.health // VIRUS_SHOOT_HEALTH 
        else:
            pct = self.health // VIRUS_MOVE_HEALTH
            width = self.rect.width * self.health // VIRUS_MOVE_HEALTH 
